...
const tasks = [
  { name: "Development", description: "Implement the new feature", projectName: "Project A" },
  { name: "Development", description: "Redesign the landing page", projectName: "Project B" },
  { name: "Testing", description: "Write unit tests for the new feature", projectName: "Project C" },
  { name: "Research", description: "Explore new technologies", projectName: "Project D" },
  { name: "Code Review", description: "Reviewed the code", projectName: "Project E" },
];
