  ...
  return (
    <Dialog.Root open={isOpen} onOpenChange={onOpenChange}>
      ...
      <Dialog.Portal>
        ...
        <Dialog.Content className={`fixed left-1/2 top-1/2 z-50 w-full ${maxWidth} -translate-x-1/2 -translate-y-1/2 rounded-xl bg-white shadow-xl focus:outline-none`}>
          ...
          <div className="flex items-center justify-between border-b border-gray-300 p-5">
            ...
            <Dialog.Close asChild>
              <button className="text-gray-400 transition-colors cursor-pointer">
                <X className="w-3 h-3" />
              </button>
            </Dialog.Close>
          </div>
