...
const Pagination = ({
  ...
  <div className="flex flex-col gap-4 lg:flex-row justify-between items-center">
    ...
    <ReactPaginate
      ...
      pageClassName=""
      pageLinkClassName="px-3 py-2 border-y-1 border-l-1 border-gray-200 transition cursor-pointer"
      previousClassName=""
      previousLinkClassName="px-3 py-2 border-y-1 border-l-1 border-gray-200 rounded-l-xl transition cursor-pointer"
      nextClassName=""
      nextLinkClassName="px-3 py-2 border-y-1 border-x-1 border-gray-200 rounded-r-xl transition cursor-pointer"
